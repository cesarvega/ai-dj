...
export class TrackSelectorComponent {
  public tracks = [
    'assets/tracks/🚀Astronaut On The Depths.mp3', // Replaced with a rocket emoji for the space theme
    ...
    'assets/tracks/❤️love-4-u-&-me.mp3', // Replaced with a red heart for a more general love theme
    ...
    'assets/tracks/aug/🎙️01 - INTRO - NICK MORGAN - Shook Part 3 & Roland Clark (LUIFER Exclusive).mp3',
    'assets/tracks/aug/🚂02 - Warren Blake, Ferra Black - Midnight Train (Extended Mix) [LTF Records].mp3',
    'assets/tracks/aug/🌅07 - Moreno & Prieto - Desde 0 (Edit).wav', // Replaced with sunrise emoji for "Desde 0"
    ...
    'assets/tracks/aug/🎛️12 - Acid DJ, Ramon Bedoya, Irwin Romero - Koki (Original Mix) [Happy Techno Limited].mp3',
    ...
    'assets/tracks/aug/🗣️20 - Steve Aguirre, Juanjo (COL) - Straight Talk (Original Mix) [Overtones Records].mp3',
    ...
    'assets/tracks/aug/⬇️ Dennis Cruz - Going Down (Original Mix) [MUSE].aiff',
    'assets/tracks/aug/MADAFKAA FOREVER.mp3',
    'assets/tracks/aug/🎙️FX - Riva Starr, Federico Grazzini, Robert Owens - Get Over [Snatch!].mp3',
    'assets/tracks/aug/✈️H - Ilario Alicante - Vacaciones En Chile (Hernán Quiez Edit).mp3',
    ...
    'assets/tracks/aug/John Junior, Angie Stone -Wish I Didn’t Miss You.wav',
    'assets/tracks/aug/🔄Lumidee - Never Leave You (Ben Miller Edit) [Master].wav',
    'assets/tracks/aug/🎛️Niccoxx, Kslö - Badtive (Original Mix) MASTER.wav',
    'assets/tracks/aug/🌑Pheelo - Shadow [GR030].wav',
    'assets/tracks/aug/🩷Rampa, Sparrow & Barbossa - Champion.mp3', // Keep the purple heart for RAMPA
